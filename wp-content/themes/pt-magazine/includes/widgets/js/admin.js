...
jQuery(function($){
  ////////////////////////////////
      ...
      jQuery(document).on('click', 'input.select-img', function( event ){
        ...
        var PTMagazineImage = wp.media.controller.Library.extend({
            defaults :  _.defaults({
        ...
        pt_magazine_file_frame = wp.media.frames.pt_magazine_file_frame = wp.media({
          button: {
        ...
        pt_magazine_file_frame.on( 'select', function() {

          var state = pt_magazine_file_frame.state('rtam-insert-image');
