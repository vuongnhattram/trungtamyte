jQuery( document ).ready(function($) {
		...
		if(numRepeaterItems > 0) {
			...
			if(numRepeaterItems > 1) {
				...
				for (i = 1; i < numRepeaterItems; ++i) {
					wellbeingAppendRow($(this), defaultValuesArray[i]);
				}
			}
		}
	});
	...
	$(this).find('.sortable').sortable({
		update: function(event, ui) {
			wellbeingGetAllInputs($(this).parent());
		}
	});
	...
	$('.sortable').on('click', '.customize-control-sortable-repeater-delete', function(event) {
		...
		if(numItems > 1) {
			$(this).parent().slideUp('fast', function() {
				...
				$(this).remove();
				wellbeingGetAllInputs(parentContainer);
			})
		}
		else {
			$(this).parent().find('.repeater-input').val('');
			wellbeingGetAllInputs($(this).parent().parent().parent());
		}
	});
	...
	$('.customize-control-sortable-repeater-add').click(function(event) {
		event.preventDefault();
		wellbeingAppendRow($(this).parent());
		wellbeingGetAllInputs($(this).parent());
	});
	...
	function wellbeingAppendRow($element, defaultValue = '') {
	...
	function wellbeingGetAllInputs($element) {
	...
	$('.google-fonts-list').on('change', function() {
		...
		var indexes = $.map(bodyfontcontrol.wellbeingfontslist, function(obj, index) {
		...
		$.each(bodyfontcontrol.wellbeingfontslist[index].variants, function(val, text) {
		...
		$(this).parent().parent().find('.google-fonts-category').val(bodyfontcontrol.wellbeingfontslist[index].category);

		wellbeingGetAllSelects($(this).parent().parent());
	});
	...
	function wellbeingGetAllSelects($element) {
		var selectedFont = {
	...
	$('.customize-control-tinymce-editor').each(function(){
		...
		var tinyMCEToolbar1String = _wpCustomizeSettings.controls[$(this).attr('id')].wellbeingtinymcetoolbar1;
		var tinyMCEToolbar2String = _wpCustomizeSettings.controls[$(this).attr('id')].wellbeingtinymcetoolbar2;
